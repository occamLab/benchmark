...
_LIDARTIMESTAMP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="timestamp",
            full_name="LidarTimestamp.timestamp",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="lidar",
            full_name="LidarTimestamp.lidar",
            index=1,
            number=2,
            type=2,
            cpp_type=6,
...
_LIDARDATA_MAPPINGPHASE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="measurements",
            full_name="LidarData.MappingPhase.measurements",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_LIDARDATA_LOCALIZATIONPHASE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="measurements",
            full_name="LidarData.LocalizationPhase.measurements",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_LIDARDATA = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[
        _LIDARDATA_MAPPINGPHASE,
        _LIDARDATA_LOCALIZATIONPHASE,
    ],
    enum_types=[],
    serialized_options=None,
    is_extendable=False,
...
_LIDARDATA_LOCALIZATIONPHASE.fields_by_name[
    "measurements"
].message_type = _LIDARTIMESTAMP
...
_LIDARDATA.fields_by_name[
    "localizationPhase"
].message_type = _LIDARDATA_LOCALIZATIONPHASE
...
LidarTimestamp = _reflection.GeneratedProtocolMessageType(
    "LidarTimestamp",
    (_message.Message,),
    {
...
LidarData = _reflection.GeneratedProtocolMessageType(
    "LidarData",
    (_message.Message,),
    {
