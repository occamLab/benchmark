...
_CLOUDANCHORRESOLVE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="timestamp",
            full_name="CloudAnchorResolve.timestamp",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="cloudAnchorName",
            full_name="CloudAnchorResolve.cloudAnchorName",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="resolvedCloudAnchorName",
            full_name="CloudAnchorResolve.resolvedCloudAnchorName",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="anchorTranslation",
            full_name="CloudAnchorResolve.anchorTranslation",
            index=3,
            number=4,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="anchorRotMatrix",
            full_name="CloudAnchorResolve.anchorRotMatrix",
            index=4,
            number=5,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="arkitTranslation",
            full_name="CloudAnchorResolve.arkitTranslation",
            index=5,
            number=6,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="arkitRotMatrix",
            full_name="CloudAnchorResolve.arkitRotMatrix",
            index=6,
            number=7,
            type=2,
            cpp_type=6,
...
_CLOUDANCHORHOST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="cloudAnchorName",
            full_name="CloudAnchorHost.cloudAnchorName",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="anchorHostRotationMatrix",
            full_name="CloudAnchorHost.anchorHostRotationMatrix",
            index=1,
            number=2,
            type=2,
            cpp_type=6,
...
_GOOGLECLOUDANCHORDATA_MAPPINGPHASE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="cloudAnchorHost",
            full_name="GoogleCloudAnchorData.MappingPhase.cloudAnchorHost",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_GOOGLECLOUDANCHORDATA_LOCALIZATIONPHASE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="cloudAnchorResolve",
            full_name="GoogleCloudAnchorData.LocalizationPhase.cloudAnchorResolve",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_GOOGLECLOUDANCHORDATA = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[
        _GOOGLECLOUDANCHORDATA_MAPPINGPHASE,
        _GOOGLECLOUDANCHORDATA_LOCALIZATIONPHASE,
    ],
    enum_types=[],
    serialized_options=None,
    is_extendable=False,
...
_GOOGLECLOUDANCHORDATA_MAPPINGPHASE.fields_by_name[
    "cloudAnchorHost"
].message_type = _CLOUDANCHORHOST
_GOOGLECLOUDANCHORDATA_MAPPINGPHASE.containing_type = _GOOGLECLOUDANCHORDATA
_GOOGLECLOUDANCHORDATA_LOCALIZATIONPHASE.fields_by_name[
    "cloudAnchorResolve"
].message_type = _CLOUDANCHORRESOLVE
_GOOGLECLOUDANCHORDATA_LOCALIZATIONPHASE.containing_type = _GOOGLECLOUDANCHORDATA
_GOOGLECLOUDANCHORDATA.fields_by_name[
    "mappingPhase"
].message_type = _GOOGLECLOUDANCHORDATA_MAPPINGPHASE
_GOOGLECLOUDANCHORDATA.fields_by_name[
    "localizationPhase"
].message_type = _GOOGLECLOUDANCHORDATA_LOCALIZATIONPHASE
...
CloudAnchorResolve = _reflection.GeneratedProtocolMessageType(
    "CloudAnchorResolve",
    (_message.Message,),
    {
...
CloudAnchorHost = _reflection.GeneratedProtocolMessageType(
    "CloudAnchorHost",
    (_message.Message,),
    {
...
GoogleCloudAnchorData = _reflection.GeneratedProtocolMessageType(
    "GoogleCloudAnchorData",
    (_message.Message,),
    {
