...
echo "---------------------NOTICE--------------------------------"
echo "supplemental_analysis_runner.sh assumes that install.sh has already been run"
echo "---------------------NOTICE--------------------------------"
...
python -m anchor.backend.data.supplements.supplemental_analysis_runner